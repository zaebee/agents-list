...
def initialize_database(
    reset: bool = False, create_admin: bool = True, create_test: bool = False
):
    ...
    try:
        ...
        if create_admin:
            print("\n=== Creating Admin User ===")
            admin_username = (
                input("Admin username (default: admin): ").strip() or "admin"
            )
            admin_email = (
            ...
            admin_password = (
                input("Admin password (default: AdminPass123!): ").strip()
                or "AdminPass123!"
            )
            admin_full_name = (
                input("Admin full name (default: System Administrator): ").strip()
                or "System Administrator"
            )

            create_admin_user(
                db, admin_username, admin_email, admin_password, admin_full_name
            )
...
def main():
    ...
    try:
        initialize_database(
            reset=reset, create_admin=create_admin, create_test=create_test
        )
