...
class ProductionHealthMonitor:
    ...
    def _load_config(self, config_file: str) -> Dict:
        ...
        default_config = {
            ...
            "retention_days": 7,
            "alert_channels": {"email": True, "slack": False, "webhook": False},
        }
    ...
    def analyze_health_status(
        self, checks: Dict[str, HealthCheck], metrics: SystemMetrics
    ) -> Dict:
...
"""
    ...
    def cleanup_old_data(self):
        ...
        self.health_history = [
            check for check in self.health_history if check.timestamp > cutoff_date
        ]
...
def main():
    ...
    parser.add_argument(
        "--config", default="monitoring-config.json", help="Configuration file path"
    )
    parser.add_argument(
